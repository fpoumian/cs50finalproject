...
def get_questions():
    questions = [
            inquirer.List("pool_known_information", message="Which of these options best describes what you knwow about your swimming pool?",
                choices=[
            ("I know the volume of my pool in gallons", "known_gallon_volume"),
            ("I do not know the volume of my pool, but I know other measurements of my pool (i.e. width, length or diameter)", "unknown_pool_volume")
                    ]
            ),
            inquirer.List("pool_shape", message="Which of these options best describes the shape of your swimming pool?",
            ...
            inquirer.Text("pool_width", validate=validate_numeric_answer,  message="Enter the width of your swimming pool (in feet)", ignore=is_pool_volume_known),
            inquirer.Text("pool_length", validate=validate_numeric_answer,  message="Enter the length of your swimming pool (in feet)", ignore=is_pool_volume_known),
            inquirer.List("pool_depth_type", message="Which of these options best describes the depth of your swimming pool?", ignore=is_pool_volume_known,
                    choices=[
            ...
            inquirer.Text("pool_constant_depth", validate=validate_numeric_answer,  message="Enter the depth of your swimming pool (in feet)", ignore=should_ignore_constant_pool_question),
            inquirer.Text("pool_variable_depth_swallow", validate=validate_numeric_answer,  message="Enter the swallow depth of your swimming pool (in feet)", ignore=should_ignore_variable_pool_question),
            inquirer.Text("pool_variable_depth_deep", validate=validate_numeric_answer,  message="Enter the deep depth of your swimming pool (in feet)", ignore=should_ignore_variable_pool_question),
            inquirer.List("pool_water_color", message="Which of these options best illustrates the color of the water in your swimming pool?",
                    choices=[
